...
export default function Gallery({ images }: { images: Image[] }) {
  return (
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 bg-pink-300">
...
function BlurImage({ image }: { image: Image }) {
  ...
  return (
    ...
    /*  <a href="#" className="group">
      ...
      <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7 z-40">
        <img
          alt=""
          ...
          style={{
            ...
            transform: isLoading
              ? 'scale(1.1) blur(2px) grayscale(1)'
